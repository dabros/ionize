...
/*
      ...
      return base64_encode(utf8_encode($szJson));
      */
      /*
      $res = '';
      try{
        $res = json_encode($data);
        $res = base64_encode(utf8_encode($res));
      }catch(Exception $e){
        log_message('error',$e->getMessage().'<pre>'.$e->getTraceAsString().'</pre>');  
        while($e = $e->getPrevious())
          log_message('error','Caused by: '.$e->getMessage().'<pre>'.$e->getTraceAsString().'</pre>');  
      }
      return $res;
